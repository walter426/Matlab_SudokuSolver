			...
			for j = 1:Sudo_0_size(2)
                ...
                if (rem(i, SubSudo_0_size(1)) == 0) && (rem(j, SubSudo_0_size(2)) == 0)
                    ...
                    for i_l = 1:SubSudo_0_size(1)
                        ...
                        %of the local matrix
                        CoorToBeOmittedAtDim1 = [1:SubSudo_0_size(1)];
                        CoorToBeOmittedAtDim1(i_l) = [];
            
                        for m = CoorToBeOmittedAtDim1
                            row_m_idx = row_start_l + m - 1;
                            
                            for n = 1:SubSudo_0_size(2)
                    ...
                    for j_l = 1:SubSudo_0_size(2)
                        ...
                        %of the local matrix
                        CoorToBeOmittedAtDim2 = [1:SubSudo_0_size(2)];
                        CoorToBeOmittedAtDim2(j_l) = [];
                        
                        for m = 1:SubSudo_0_size(1)
                            row_m_idx = row_start_l + m - 1;
                            
                            for n = CoorToBeOmittedAtDim2
                                col_n_idx = col_start_l + n - 1;
